...
import static ru.ncedu.java.tasks.interfaces.ex2.Employees.average;
import static ru.ncedu.java.tasks.interfaces.ex2.Employees.largest;
...
public class Main {
    public static void main(String[] args){
        ...
        Employees employees = (Employees)largest(gryffindor);
        System.out.println(employees.getName()); // Garry Potter
    }
}
